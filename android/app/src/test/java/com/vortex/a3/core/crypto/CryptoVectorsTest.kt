...
/**
 * Verify a3 crypto matches canonical V1 vectors generated by l3 (Rust + snow).
 * If any of these fails, Android and Linux disagree on the wire — a V1
 * compliance failure.
 */
class CryptoVectorsTest {
    ...
    private fun locateVectorsDir(): File {
        // Walk up from the working directory until we find shared/vectors/v1.
